      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-5xl lg:text-6xl font-light text-[#0C141F] mb-6">
            Our Growth <span className="text-[#A9111D] font-normal">Journey</span>
          </h2>
          ...
          <p className="text-xl text-[#0C141F]/80 max-w-4xl mx-auto leading-relaxed font-light">
            From a single parking facility to a global multi-industry powerhouse. Discover the key milestones that
            shaped USP Holdings into the industry leader we are today.
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          {timeline.map((item, index) => (
            ...
            >
              {/* Content Card */}
              <div className={`w-full md:w-5/12 ${index % 2 === 0 ? "pr-12 text-right" : "pl-12 text-left"}`}>
                <motion.div
                ...
                >
                  ...
                  {/* Event Description */}
                  <h3 className="text-xl font-semibold text-[#0C141F] mb-3 leading-tight">{item.event}</h3>

                  {/* Impact Statement */}
                  <p className="text-[#0C141F]/70 font-medium">{item.impact}</p>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-light text-white mb-4">25 Years of Remarkable Growth</h3>
            <p className="text-white/70 max-w-2xl mx-auto">
              From humble beginnings to industry leadership, our journey reflects unwavering commitment to excellence
              and innovation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { number: "2005", label: "Diversified", desc: "Real Estate Development" },
        ...
        >
          <div className="bg-gradient-to-r from-[#A9111D]/10 to-[#0C141F]/10 rounded-2xl p-8 border border-[#A9111D]/20">
            <h3 className="text-2xl font-light text-[#0C141F] mb-4">Looking Forward</h3>
            <p className="text-[#0C141F]/80 max-w-3xl mx-auto leading-relaxed">
              As we continue our journey, USP Holdings remains committed to sustainable development, community
              empowerment, and creating lasting legacies for future generations. The next chapter of our story is just
              beginning.
            </p>
          </div>
        </motion.div>
