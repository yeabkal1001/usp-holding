...
export const AnimatedTestimonials = ({
  ...
  // Precompute random rotation values for each testimonial, stable for hydration
  const randomRotations = useMemo(() => {
    // Use a stable seed based on testimonial src and index
    ...
    return testimonials.map((t, i) => seededRandom(t.src + '-' + i))
  }, [testimonials])
          ...
          >
            <div className="flex gap-4 pt-12 md:pt-0">
              <div className="flex flex-col">
                <h3 className="font-bold text-2xl text-white">{testimonials[active].name}</h3>
