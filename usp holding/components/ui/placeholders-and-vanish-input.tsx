...
export function PlaceholdersAndVanishInput({
  ...
  }, [placeholders, startAnimation, handleVisibilityChange, mounted])
  ...
  const draw = useCallback(() => {
    ...
    try {
      ...
      console.warn("Error in draw function:", error)
    }
  }, [value, mounted])
  ...
  if (!mounted) {
    return (
      <form className="w-full relative max-w-xl mx-auto bg-white dark:bg-zinc-800 h-12 rounded-full overflow-hidden shadow-lg">
        <input
          type="text"
